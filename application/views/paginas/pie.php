      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2018 <a href="#">ApietTravel</a>.</strong> Todos los derechos reservados.
      </footer>
    ...
    <!-- CRUDs -->
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/dist/js/employee.js"></script>
